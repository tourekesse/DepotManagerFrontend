...
export function SitemarkIcon() {
  return (
    <SvgIcon sx={{ height: 32, width: 160 }}>
      <svg
        width="160"
        height="32"
        viewBox="0 0 160 32"
      ...
      >
        {/* Dépôt Manager Logo - Left text */}
        <text x="0" y="22" fill="#000000" fontSize="20" fontWeight="bold" fontFamily="Arial">Dépôt</text>

        {/* Center Icon - Phone with chart */}
        <g transform="translate(55, 4)">
          {/* Green circle */}
          <circle cx="12" cy="12" r="11" fill="none" stroke="#7CB342" strokeWidth="2.5" />
          {/* Orange phone */}
          <rect x="6" y="5" width="11" height="14" rx="1.5" fill="#FF9800" />
          {/* Screen */}
          <rect x="8" y="7" width="8" height="10" fill="#FFF3E0" />
          {/* Check mark */}
          <path d="M9 11 L10 12 L12 10" stroke="#7CB342" strokeWidth="1.2" fill="none" />
          {/* Chart bars */}
          <rect x="8" y="14" width="1.5" height="1.5" fill="#FF9800" />
          <rect x="10" y="13" width="1.5" height="3" fill="#FF9800" />
          <rect x="12" y="12" width="1.5" height="4.5" fill="#FF9800" />
        </g>

        {/* Right text - Manager */}
        <text x="95" y="22" fill="#000000" fontSize="20" fontWeight="bold" fontFamily="Arial">Manager</text>
      </svg>
    </SvgIcon>
  );
}
