...
export default function DashboardSidebarPageItem({
  ...
  const handleClick = React.useCallback(() => {
    if (onPageItemClick) {
      ...
      // Close drawer on mobile - MUI Core pattern like toggleDrawer(false)
      if (!nestedNavigation && !isOverSmViewport && setExpanded) {
        setExpanded(false);
      }
    }
  }, [onPageItemClick, id, nestedNavigation, isOverSmViewport, setExpanded]);
