...
export default function CommandeDepotList() {
    ...
    const loadData = React.useCallback(async () => {
        ...
        try {
            // Récupérer toutes les commandes du point de vente
            const res = await privateApi.get(`/api/commandes?pointDeVenteId=${pvId}`);
    ...
    const columns = React.useMemo(() => [
        ...
        },
        {
            ...
            renderCell: (params) => {
                ...
                return (
                    <Chip
                        label={estLivree ? '✅ Livrée' : '🟠 À livrer'}
                        size="small"
                        sx={{
                            bgcolor: bgColor,
                            color: color,
